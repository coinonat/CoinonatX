...
#
# run with a mounted directory for ~/.CoinonatX:
#   docker run -it -p 15015:15015 -v /path/to/a/local/directory:/root/.CoinonatX coinonatx
#
...
#    docker run -it -p 15015:15015 -p 5000:XXX -v /path/to/a/local/directory:/root/.CoinonatX coinonatx # Replace XXX with set rpcPort in coinontax.conf
