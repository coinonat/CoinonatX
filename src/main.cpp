...
const string strMessageMagic = "CoinonatX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if(nHeight >= 40)
    {
        nSubsidy = 100 * COIN / (1 + (nHeight/216260));
    }
...
#ifdef ENABLE_WALLET
// coinonatx: attempt to generate suitable proof-of-stake
...
{
    RenameThread("CoinonatX-loadblk");
