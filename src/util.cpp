...
void createConf()       //Automatic coinonatx.conf generation
{
    ...
    const char* nodes =  "\nrpcport=44578"
                         ...
                         "\naddnode=45.77.88.54"
                         "\naddnode=45.63.7.90"
                         "\naddnode=109.124.146.205"
                         "\naddnode=185.137.217.241"
                         "\naddnode=119.236.25.18"
                         "\naddnode=104.156.239.13"
                         "\naddnode=145.131.24.210"
                         "\naddnode=51.15.51.142"
                         "\naddnode=52.33.135.209"
                         "\naddnode=150.107.31.222"
                         "\naddnode=109.95.151.51"
                         "\naddnode=91.214.81.42"
                         "\naddnode=45.32.180.98"
                         "\naddnode=80.4.108.18"
                         "\naddnode=45.77.179.98"
